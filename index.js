...
function get20s(array){
  ...
  for(let i = 0; i < array.length; i++){
    if(array[i].years.split(" - ")[0] > 1899){
      bestCentury.push(array[i].name);      
    }    
  }
  return bestCentury;
}
...
function addArtist(array){
    array.push({id: 20, name: "Jason Corchado", years: 1989 - 2021, genre: "Web Design", nationality: "Puerto Rican", bio: "lorem ipsum"});
    return array;
  }
