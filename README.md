...
A: Acessibility is using values that work universally based on the parameters of the page in use.
2. Talk about 3 different things you can do to ensure your website is accessible.
A: Use Rem for font resizing, use percentages for sizing anything other then font, use vh to determine height in some cases where percentages wouldnt apply.
3. How would you explain the concept of a variable to someone new to programming?
A: A variable is something you can store things in.
4. What is the purpose of using functions in code?
A: function are reusable so if you change the parameters they can work intended as many times for different things.
